...
training_loader, testing_loader, validation_loader = alkaline.load_data()


alkaline.load_checkpoint(path)
...
probabilities = alkaline.predict(path_image, model, number_of_outputs, power)
